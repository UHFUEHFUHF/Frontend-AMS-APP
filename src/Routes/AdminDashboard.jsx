    ...
    <div className="flex">
      ...
      <div className="md:h-full md:w-48 bg-indigo-500 md:flex flex-col mt-16 gap-8 ml-2 rounded-2xl p-4 hidden">
        ...
        <div className="flex flex-col gap-4 text-white font-medium">
          <Link to="/admin" className="flex items-center gap-2 hover:text-indigo-200 transition cursor-pointer">
        ...
        <Link to="admin/add/students" className="flex items-center gap-2 hover:text-indigo-200 transition cursor-pointer">
